            ...
            children: [
              ...
              const Text(
                ...
                style: TextStyle(
                  ...
                  color: Color(0xFF8B5E83), // Dark pink shade
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor:
                      const Color(0xFFEE3A60), // Primary pink color
                  padding: const EdgeInsets.symmetric(vertical: 15.0),
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(25.0),
                  ),
                  elevation: 5,
                  shadowColor: const Color(0xFFEE3A60),
                ),
                child: const Center(
                  child: Text(
                    "Login",
              ...
              const SizedBox(height: 20),
              // Decorative Dots (similar to Onboarding)
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
