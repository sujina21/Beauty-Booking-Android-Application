...
import 'package:sprint_1/features/home/presentation/view/bottom_view/about_us.dart';
import 'package:sprint_1/features/home/presentation/view/bottom_view/favourite_page.dart';
import 'package:sprint_1/features/home/presentation/view/bottom_view/makeup_screen.dart';
import 'package:sprint_1/features/home/presentation/view/bottom_view/nails_screen.dart';
...
class DashboardScreenState extends State<DashboardScreen> {
  int selectedIndex = 0;
  final List<Map<String, String>> favouriteServices = [
    {
      'service': 'Makeup',
  ...
  Widget _buildBottomNavigationBar(BuildContext context) {
    return BottomNavigationBar(
      ...
      onTap: (index) {
        if (index == 1) {
          // Pass the favouriteServices list when navigating to FavouriteScreen
          Navigator.push(
            context,
            MaterialPageRoute(
